...
I enjoy writing tools to test the security of configuration management platforms like SCCM and Intune. I'm the author of [SharpSCCM](https://github.com/Mayyhem/SharpSCCM), [ConfigManBearPig](https://github.com/SpecterOps/ConfigManBearPig), [MSSQLHound](https://github.com/SpecterOps/MSSQLHound), and [Maestro](https://github.com/Mayyhem/Maestro), co-author of [Misconfiguration Manager](https://github.com/subat0mik/Misconfiguration-Manager) with Duane Michael ([@subat0mik](https://x.com/subat0mik)) and Garrett Foster ([unsigned_sh0rt](https://x.com/unsigned_sh0rt)), and have contributed to a few other offensive security tools, including [SCCM Hunter](https://github.com/garrettfoster13/sccmhunter), [impacket](https://github.com/fortra/impacket/pull/2122), [pxethiefy](https://github.com/csandker/pxethiefy), and [SCMKit](https://github.com/h4wkst3r/SCMKit).
...
- [DEF CON Workshops 2024: Offensive SCCM - Abusing Microsoft's C2 Framework](https://defcon.org/html/defcon-32/dc-32-workshops.html), with Duane Michael ([@subat0mik](https://x.com/subat0mik)) and Garrett Foster ([@unsigned_sh0rt](https://x.com/unsigned_sh0rt))
